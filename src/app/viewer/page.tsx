...
import { LogOut, Activity, Moon, Sun, TestTube2, LayoutDashboard } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 bg-mesh selection:bg-indigo-500/30 transition-colors duration-300">
            ...
            <main className="max-w-[1920px] mx-auto p-4 flex gap-4 h-[calc(100vh-64px)] overflow-hidden">
                <div className={`w-full h-full flex gap-4 ${activeTab === 'dashboard' ? '' : 'hidden'}`}>
                        ...
                        {selectedPatient ? (
                            ...
                            <div className="h-full flex items-center justify-center">
                                <div className="text-center">
                                    ...
                                    <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Welcome to Clinical Hub</h2>
                ...
                <div className={`w-full h-full ${activeTab === 'simulation' ? '' : 'hidden'}`}>
                    <SimulationDashboard />
                </div>
            </main>
        </div>
